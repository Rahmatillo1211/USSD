...
class InternetPaketlarScreen extends StatefulWidget {
...
class _InternetPaketlarScreenState extends State<InternetPaketlarScreen> {
  @override
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InternetPaketlarCardWidget(
          ...
          gbColor: const Color(0xFFFFBE00),
        );
      },
    );
  }
