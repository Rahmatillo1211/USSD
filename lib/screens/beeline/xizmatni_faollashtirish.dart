...
class XizmatniFaollashtirishScreen extends StatelessWidget {
  const XizmatniFaollashtirishScreen({super.key});
            ...
            child: Column(
              children: [
                XizmatniFaollashtirishWidget(
                  narxColor: Color(0xFFFFBE00),
                ),
                SizedBox(
                  height: 12,
                ),
                XizmatniFaollashtirishWIdget2(
                  codesColor: Color(0xFFFFBE00),
                ),
                SizedBox(
                  height: 12,
                ),
