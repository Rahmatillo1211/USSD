...
class UcellXizmatniFaollashtirishScreen extends StatelessWidget {
  const UcellXizmatniFaollashtirishScreen({super.key});
            ...
            child: Column(
              children: [
                XizmatniFaollashtirishWidget(
                  narxColor: Color(0xFF652D86),
                ),
                SizedBox(
                  height: 12,
                ),
                XizmatniFaollashtirishWIdget2(
                  codesColor: Color(0xFF652D86),
                ),
                SizedBox(
                  height: 12,
                ),
