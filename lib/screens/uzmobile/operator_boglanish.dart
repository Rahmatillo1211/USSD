...
class UzmobileOperatorBilanBoglanishScreen extends StatelessWidget {
  const UzmobileOperatorBilanBoglanishScreen({super.key});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "“Beeline” Qo’llab-quvvatlash markazi",
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w400,
            ),
