...
class UzmobileXizmatniFaollashtirishScreen extends StatelessWidget {
  const UzmobileXizmatniFaollashtirishScreen({super.key});
            ...
            child: Column(
              children: [
                XizmatniFaollashtirishWidget(
                  narxColor: Color(0xFF01B4FF),
                ),
                SizedBox(
                  height: 12,
                ),
                XizmatniFaollashtirishWIdget2(
                  codesColor: Color(0xFF01B4FF),
                ),
                SizedBox(
                  height: 12,
                ),
