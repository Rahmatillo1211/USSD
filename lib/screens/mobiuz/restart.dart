...
class MobiRestartXizmatiScreen extends StatelessWidget {
  const MobiRestartXizmatiScreen({super.key});
            ...
            child: Column(
              children: [
                RestartXizmatiWIdget(
                  restartColor: Color.fromARGB(255, 179, 0, 12),
                ),
                SizedBox(
                  height: 12,
                ),
                InernetniFaollashtirishCardWidget2(
                  ...
                  tekskod: ' *555#F',
                  codeColor: Color.fromARGB(255, 179, 0, 12),
                ),
                SizedBox(
                  height: 12,
                ),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context) =>
                              ...
                              buttonColor: Color.fromARGB(255, 179, 0, 12),
                            ),
                          ),
                        );
                      },
