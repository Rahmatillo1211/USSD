...
import 'package:flutter_application_1/widgets/xizmatniFaollashtirishWidget.dart';
import 'package:flutter_application_1/widgets/xizmatniFaollshtirishWidget2.dart';

class MobiXizmatniFaollashtirishScreen extends StatelessWidget {
  const MobiXizmatniFaollashtirishScreen({super.key});
      ...
      children: [
        const SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                XizmatniFaollashtirishWidget(
                  narxColor:  Color.fromARGB(255, 179, 0, 12),
                ),
                SizedBox(
                  height: 12,
                ),
                XizmatniFaollashtirishWIdget2(
                  codesColor:  Color.fromARGB(255, 179, 0, 12),
                ),
                SizedBox(
                  height: 12,
                ),
        ...
        return AlertDialog(
          ...
          content: Container(
            ...
            child: Column(
              children: [
                const Text(
                  "Siz “Sizga qo’n’giroq qilishdi” xizmatini faollashtirmoqchisiz."
                  "\fXizmat narxi: 240 so’m/kun"
                  "\fAmal qilish muddati: Cheksiz",
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w400,
                  ),
  ...
  _showMyDialog2(BuildContext ctx) {
    return showDialog(
      context: ctx,
      barrierDismissible: false,
      builder: (BuildContext context) {
