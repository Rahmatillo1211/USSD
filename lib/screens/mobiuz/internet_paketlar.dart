...
class MobiInternetPaketlarScreen extends StatefulWidget {
  const MobiInternetPaketlarScreen({super.key});
...
class _InternetPaketlarScreenState extends State<MobiInternetPaketlarScreen> {
  @override
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildInternetPaketGrid(beeInternetPaketlarList),
          ],
        ),
      ),
    );
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InternetPaketlarCardWidget(
          ...
          gbColor: const Color.fromARGB(255, 179, 0, 12),
        );
      },
    );
  }
