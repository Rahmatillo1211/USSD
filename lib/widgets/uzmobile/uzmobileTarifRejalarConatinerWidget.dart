...
import 'package:flutter_application_1/screens/uzmobile/tarif_rejalar2.dart';
...
class UzmobileTarifRejalarWidget extends StatelessWidget {
  const UzmobileTarifRejalarWidget({super.key});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const UzmobileTarifRejalarScreen2(),
                    ),
                  );
                },
                child: const Text(
            ...
            _buildBarakaGrid(uzmobileBarakaliList),
            const SizedBox(
              height: 5,
            ),
            const Padding(
